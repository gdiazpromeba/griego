...
public class DiccionarioDAOImpl extends JdbcDaoSupport implements DiccionarioDAO {
	...
	/* (non-Javadoc)
	 * @see kalos.dao.DiccionarioDAO#selectPorNeutralizadaLike(java.lang.String, kalos.enumeraciones.LugarSubcadena)
	 */
	...
	/**
	 * convierte el array de tipos de palabra en la parte paaramétrica de una cadena SQL
	 * @param tipos
	 * @return
	 */
