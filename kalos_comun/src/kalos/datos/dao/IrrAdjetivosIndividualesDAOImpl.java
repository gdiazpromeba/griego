...
public class IrrAdjetivosIndividualesDAOImpl extends JdbcDaoSupport implements IrrAdjetivosIndividualesDAO {
	...
	/* (non-Javadoc)
	 * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#getRegistros(java.util.List)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#seleccionaPorAdjetivo(java.lang.String)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#seleccionIndividual(java.lang.String)
	 */
	public IrrAdjetivoIndividual seleccionIndividual(String irrAdjetivoIndividualId) {
		List<IrrAdjetivoIndividual> lstAux = seleccionIndividual
				.execute(new Object[] { irrAdjetivoIndividualId });
		if (lstAux.size() == 0)
			return null;
		else
			return lstAux.get(0);
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#inserta(kalos.beans.IrrAdjetivoIndividual)
	 */
	public void inserta(IrrAdjetivoIndividual iae) {
		...
		insercion.update(new Object[] { 
				...
				Numero.getInt(iae.getNumero()),
				Caso.getInt(iae.getCaso()),
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#modifica(kalos.beans.IrrAdjetivoIndividual)
	 */
	public void modifica(IrrAdjetivoIndividual bean) {
		modificacion.update(new Object[] { 
				...
				Numero.getInt(bean.getNumero()),
				Caso.getInt(bean.getCaso()),
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#borra(java.lang.String)
	 */
