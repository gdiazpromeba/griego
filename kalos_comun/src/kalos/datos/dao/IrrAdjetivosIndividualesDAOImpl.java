...
public class IrrAdjetivosIndividualesDAOImpl extends JdbcDaoSupport implements IrrAdjetivosIndividualesDAO {
     ...
     * 
     * @see
     * kalos.datos.dao.IrrAdjetivosIndividualesDAO#seleccionaPorForma(java.lang
     * .String)
     */
    @Override
     ...
     * 
     * @see
     * kalos.datos.dao.IrrAdjetivosIndividualesDAO#getRegistros(java.util.List)
     */
    /*
     * (non-Javadoc)
     * 
     ...
     * 
     * @see
     * kalos.datos.dao.IrrAdjetivosIndividualesDAO#seleccionaPorAdjetivo(java
     * .lang.String)
     */
    /*
     * (non-Javadoc)
     ...
     * 
     * @see
     * kalos.datos.dao.IrrAdjetivosIndividualesDAO#seleccionIndividual(java.
     * lang.String)
     */
    /*
     * (non-Javadoc)
     ...
     * 
     * @see
     * kalos.datos.dao.IrrAdjetivosIndividualesDAO#seleccionaPartics(java.lang
     * .String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#inserta(kalos.beans.
     ...
     * (non-Javadoc)
     * 
     * @see kalos.datos.dao.IrrAdjetivosIndividualesDAO#modifica(kalos.beans.
     * IrrAdjetivoIndividual)
     */
    /*
     * (non-Javadoc)
