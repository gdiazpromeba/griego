...
import kalos.datos.dao.IrrAdjetivosIndividualesDAO;
...
public class GerenteIrrAdjetivosIndividualesImpl implements GerenteIrrAdjetivosIndividuales {
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteIrrAdjetivosIndividuales#seleccionaPorAdjetivo(java.lang.String)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteIrrAdjetivosIndividuales#seleccionIndividual(java.lang.String)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteIrrAdjetivosIndividuales#inserta(kalos.beans.IrrAdjetivoIndividual)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteIrrAdjetivosIndividuales#modifica(kalos.beans.IrrAdjetivoIndividual)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteIrrAdjetivosIndividuales#borra(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteIrrAdjetivosIndividuales#getBeans(java.util.List)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteIrrAdjetivosIndividuales#setIrrAdjetivosEnterosDAO(kalos.datos.dao.IrrAdjetivosIndividualesDAO)
	 */
