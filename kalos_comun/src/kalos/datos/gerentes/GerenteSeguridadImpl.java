...
public class GerenteSeguridadImpl implements GerenteSeguridad {
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSeguridad#getNombre()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSeguridad#registra(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSeguridad#setSeguridadDAO(kalos.datos.dao.SeguridadDAO)
	 */
	@Override
