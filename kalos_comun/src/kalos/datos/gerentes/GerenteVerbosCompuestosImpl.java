...
import kalos.datos.dao.PreposicionesEnVerbosDAO;
import kalos.datos.dao.VerbosCompuestosDAO;
...
public class GerenteVerbosCompuestosImpl implements GerenteVerbosCompuestos  {
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteVerbosCompuestos#seleccionaInidvidual(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteVerbosCompuestos#seleccionaPorVerboSimple(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteVerbosCompuestos#seleccionaPorVerboCompuesto(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteVerbosCompuestos#inserta(kalos.beans.VerboSimpleCompuesto)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteVerbosCompuestos#borraIndividual(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteVerbosCompuestos#borraPorVerboCompuesto(java.lang.String)
	 */
