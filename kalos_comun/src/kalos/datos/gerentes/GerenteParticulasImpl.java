...
import kalos.datos.dao.ParticulasDAO;
...
public class GerenteParticulasImpl implements GerenteParticulas {
    ...
    /* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteParticulas#seleccionaIdsPorEncabezado(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteParticulas#seleccionaParticulasDadoEncabezadoSinSignificado(java.lang.String, boolean)
	 */
