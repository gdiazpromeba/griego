...
import kalos.datos.dao.SignificadoDAO;
...
public class GerenteSignificadosImpl implements GerenteSignificados {
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSignificados#pueblaTodosLosSignificados(kalos.beans.ISignificados)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSignificados#inserta(kalos.beans.Significado)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSignificados#modifica(kalos.beans.Significado)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSignificados#borra(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteSignificados#pueblaTodosLosSignificados(java.util.List)
	 */
