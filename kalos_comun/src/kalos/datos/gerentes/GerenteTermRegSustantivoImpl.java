...
import kalos.datos.dao.TermRegSustantivoDAO;
...
public class GerenteTermRegSustantivoImpl implements GerenteTermRegSustantivo   {
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteTermRegSustantivo#seleccionaPorTerminacion(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see kalos.datos.gerentes.GerenteTermRegSustantivo#seleccionaMaxSubindice(int, int, int)
	 */
