...
/**
 * Indica que este control puede reaccionar a una orden de cambiar el tamaño de su tipografia
 * @author <a href="mailto:gonzalo.diaz@turner.com">Gonzalo Diaz</a>
 * @version $Revision: 1.0 $
 */
public interface TipografiaCambiable {
    
    void cambiaTamañoFont(float tamaño);
