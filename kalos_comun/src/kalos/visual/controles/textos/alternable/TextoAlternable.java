package kalos.visual.controles.textos.alternable;
 ...
 * con o sin diacr�ticos. Permite especificar si se debe hacer una 
...
public class TextoAlternable extends JPanel {
  ...
  /**
   * cadena completa �nica, considerando que la inserci�n unicode se hace cargo de largas y breves
   */
...
//    });
  ...
  private void inicializaControles(){
	...
	FormLayout layout=new FormLayout(
			"pref:grow(1), 3dlu, pref, 3dlu, pref, 9dlu, pref ", // cols
		    "15dlu" // rows
	);
	...
	//en los "looks and feels" Kunststoff y Aqua, cuanto inserto una may�scula 
	//con esp�ritu y acento al principio de la palabra, los diacr�ticos quedan un poco comidos.
	//La clase TextUIBasica soluciona el problema para los looks and feels b�sicos, pero un intento similar para Kunststoff falla.
	...
	/**
	 * Se activa al parder el foco, y realiza algunas correcciones autom�ticamente
	 */
