...
public class Recursos {
	...
	private static Locale locale;
		...
		//	private static org.apache.log4j.Logger logger=org.apache.log4j.Logger.getLogger(Recursos.class.getName());
...
//	private static Font font = new Font("Galatia SIL (True Type)", Font.PLAIN, 12);
...
//	private static Font font = new Font("GFS Didot", Font.PLAIN, 12);
	 ...
	 * @param clave			la clave de recurso cadena.
	 * @param sustiticiones   items de array
	 *                        que no cambian según el idioma, y son sustituidos 
	 * 						en el recurso. Por ejemplo, "página {1} de {2}".
	 * @return                El recurso ya internacionalizado y sustituido, por
	 * 						ejemplo "página 3 de 40" o "page 3 of 40".
	 */
	...
	public static void cambiaLocale(String localeName) {
		...
		recursos = ResourceBundle.getBundle("kalos.recursos.Mensajes", locale);
	}
