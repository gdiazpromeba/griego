...
public class OpBeans {
    ...
    public static String getId(Object obj) {
        ...
        try {
            ...
            Method method = class1.getMethod("getId", new Class[0]);
    ...
    public static Object clona(Object obj) {
        try {
            //            Object nueva = org.springframework.beans.BeanUtils.instantiateClass(obj.getClass());
    ...
    public static void setPropiedad(Object obj, String s, Object obj1) {
        try {
            BeanUtils.setProperty(obj, s, obj1);
        } catch (Exception exception) {
            throw new RuntimeException((new StringBuilder())
                    .append("la propiedad ").append(s)
                    .append(" no existe en el bean ").append(obj)
