 ...
 * diacríticos. Permite especificar si se debe hacer una correspondencia exacta
...
public class TextoAlternable extends JPanel {
    ...
    private JToggleButton beta = new JToggleButton(new ImageIcon(CargaRecursos.getResourceURL("img/a16.gif")));
    private JToggleButton alfa = new JToggleButton(new ImageIcon(CargaRecursos.getResourceURL("img/alpha16.gif")));

    /**
     * cadena completa única, considerando que la inserción unicode se hace
    ...
    public TextoAlternable(boolean permitePosicion) {
        ...
        alfa.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                esBeta = false;
                //		alfa.setIcon(new ImageIcon(CargaRecursos.getResourceURL("img/alfa.gif")));
                //		beta.setIcon(new ImageIcon(CargaRecursos.getResourceURL("a_arriba.gif")));
        ...
        beta.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                esBeta = true;
                //		alfa.setIcon(new ImageIcon(CargaRecursos.getResourceURL("img/alfa_arriba.gif")));
                //		beta.setIcon(new ImageIcon(CargaRecursos.getResourceURL("img/a.gif")));
