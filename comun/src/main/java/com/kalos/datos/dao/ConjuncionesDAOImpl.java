...
public class ConjuncionesDAOImpl extends JdbcDaoSupport implements ConjuncionesDAO {
    ...
    abstract class SeleccionAbstractasinSignificado extends MappingSqlQuery {
        ...
        protected Object mapRow(ResultSet resultset, int i) throws SQLException {
            com.kalos.beans.ConjuncionBean e = new com.kalos.beans.ConjuncionBean();
    ...
    private void puebla() {
        ...
        stringbuffer.append((new StringBuilder()).append("  AND SIG.IDIOMA='")
                .append(com.kalos.recursos.Configuracion.getIdiomaSignificados()).append("'    \n").toString());
        ...
        stringbuffer.append("      ON CONJ.CONJUNCION_ID=SIG.REFERENTE_ID       \n");
        stringbuffer.append("WHERE  \n");
        stringbuffer.append((new StringBuilder()).append("  SIG.IDIOMA='").append(com.kalos.recursos.Configuracion.getIdiomaSignificados()).append("'    \n").toString());
        stringbuffer.append("ORDER BY  \n");
        stringbuffer.append("  CONJ.CODIGO   \n");
    ...
    public List seleccionaPorSubtipo(SubtipoConjuncion stc) {
        List list = selIdsPorSubtipo.execute(stc.abreviatura());
        return list;
    }
    ...
    public com.kalos.beans.ConjuncionBean seleccionaInidvidual(String s) {
        List list = selPorIdConSig.execute(new Object[] { s });
        if (list.size() == 0)
            return null;
        else
            return (com.kalos.beans.ConjuncionBean) list.get(0);
    }

    public com.kalos.beans.ConjuncionBean seleccionaInidvidualParaAM(String s) {
