...
public class GerenteAdjetivosComoNominalesImpl implements GerenteAdjetivosComoNominales {
	...
	/* (non-Javadoc)
	 * @see com.kalos.datos.gerentes.GerenteAdjetivosComoNominales#borraTodo()
	 */
	...
	/* (non-Javadoc)
	 * @see com.kalos.datos.gerentes.GerenteAdjetivosComoNominales#inserta(kalos.beans.AdjetivoComoNominalBean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.kalos.datos.gerentes.GerenteAdjetivosComoNominales#seleccionaPorGenitivoParaAM(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.kalos.datos.gerentes.GerenteAdjetivosComoNominales#seleccionaPorNominativoAM(java.lang.String)
	 */
