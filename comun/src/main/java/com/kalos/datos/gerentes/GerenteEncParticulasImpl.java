...
public class GerenteEncParticulasImpl implements InitializingBean, SeleccionadorUnoTodos, GerenteEncParticulas {
    ...
    /* (non-Javadoc)
     * @see com.kalos.datos.gerentes.GerenteEncParticulasImpl#afterPropertiesSet()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.kalos.datos.gerentes.GerenteEncParticulasImpl#seleccionaUno(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.kalos.datos.gerentes.GerenteEncParticulasImpl#setEncParticulasDAO(kalos.datos.dao.EncParticulasDAO)
     */
    @Override
